...
{
    public class CreateApplicationEV2 : DESFireEV2Action<Leosac.CredentialProvisioning.Encoding.Chip.DESFire.CreateApplicationEV2>
    {
        public CreateApplicationEV2(Leosac.CredentialProvisioning.Encoding.Chip.DESFire.CreateApplicationEV2 properties) : base(properties)
        {
